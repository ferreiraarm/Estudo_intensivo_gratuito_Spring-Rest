...
# Api Rest: Da palestra de intensivo spring rest api.

## Essa API, fornene os seguintes endpointes

## Para parcelamento:

### Lista todos os parcelamentos, listar por identificador, e cadastrar parcelamento.

## Para clientes:

### Lista todos os clientes, listar por nome, listar do identificador adicionar cliente, atualizar por identificador e deletar por identificador.
